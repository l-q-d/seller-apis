...
def get_offer_ids(client_id, seller_token):
    ...
    Возвращаемое значение:
        list: со строками, где каждая строка это артикуль товара.
...
def create_stocks(watch_remnants, offer_ids):
    ...
    Функция принимает список остатков часов и список артикуль товаров на Ozon, 
    формирует список словарей с остатками для отправки на Ozon.

    Аргументы:
        watch_remnants(list): Со словарями с остатками часов.
        offer_ids(list): артикулы товаров на Ozon.
...
def create_prices(watch_remnants, offer_ids):
    ...
    Аргументы:
        ...
        offer_ids(list): артикуль товаров на Ozon.
...
async def upload_prices(watch_remnants, client_id, seller_token):
    ...
    Функция асинхронно получает артикуль товаров, создает список цен и загружает их на Ozon, 
...
async def upload_stocks(watch_remnants, client_id, seller_token):
    ...
    Функция асинхронно получает артикуль товаров, создает список остатков и загружает их на Ozon, 
    используя пагинацию для отправки больших списков.
